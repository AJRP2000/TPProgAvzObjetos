...
public class JPanelAltaTurnoAdmin extends JPanelABMCTurno {

	public JPanelAltaTurnoAdmin(CentroTerapeutaModel terapeutaModel, Usuario usuario) {
	...
	protected void initUI() {
		...
		String titulo = "Alta Turno Admin";
