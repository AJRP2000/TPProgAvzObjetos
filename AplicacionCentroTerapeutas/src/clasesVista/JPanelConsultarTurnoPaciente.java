...
public class JPanelConsultarTurnoPaciente extends JPanelABMCTurno {

	public JPanelConsultarTurnoPaciente(CentroTerapeutaModel terapeutaModel, Usuario usuario) {
	...
	protected void initUI() {
		...
		String titulo = "Consultar Turno Admin";
